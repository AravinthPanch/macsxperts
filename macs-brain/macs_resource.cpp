...
macs_resource::macs_resource() {
	...
	resourceTable[3]("0xECx1", "P2,3,4: ON");
	resourceTable[4]("0xECx0", "P2,3,4: OFF");
	...
	resourceTable[8]("0xP4x1", "P4: ON");
	resourceTable[9]("0xP4x0", "P4: OFF");
	...
	resourceTable[14]("0xP4x11", "P4 is switched ON");
	resourceTable[15]("0xP4x00", "P4 is switched OFF");
}
